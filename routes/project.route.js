...
// 2. IMPORT YOUR DELIVERABLE ROUTER
const deliverableRouter = require("./deliverable.route");

// 3. IMPORT YOUR TIME ENTRY ROUTER (THIS WAS MISSING)
const timeEntryRouter = require("./timeEntry.route"); // <-- ADD THIS
...
router.use("/:projectId/tasks", taskRouter);
router.use("/:projectId/deliverables", deliverableRouter);

// 4. "USE" THE TIME ENTRY ROUTER (THIS WAS MISSING)
router.use("/:projectId/time-entries", timeEntryRouter); // <-- ADD THIS
